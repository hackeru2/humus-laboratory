...
const defaults = {
  ...
  async highlighter(code, lang, theme, highlights) {
    if (process.browser && window.sessionStorage.getItem("mdc-shiki-highlighter") === "browser") {
      return import('../nitro/node-server.mjs').then(function (n) { return n.ac; }).then(({ useShikiHighlighter }) => {
...
const rehypePlugins = {
  ...
  'highlight': { instance: rehypeShiki, options: {"src":"/Users/amirlifshitz/projects/gpt/vues/humus-laboratory/node_modules/@nuxtjs/mdc/dist/runtime/shiki/index.mjs"} },
};
