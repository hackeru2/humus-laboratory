...
import { j as useState, Y as useRuntimeConfig } from '../server.mjs';
import { l as hash } from '../../nitro/node-server.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-SikIwG9o.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-EOYOLOTG.mjs').then((m) => m.generateNavigation);
