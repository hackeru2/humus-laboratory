import { Y as useRuntimeConfig, U as useRequestEvent } from '../server.mjs';
import { a0 as withLeadingSlash, j as joinURL, w as withoutTrailingSlash, a3 as withBase, l as hash } from '../../nitro/node-server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-EOYOLOTG.mjs').then((m) => m.useContentDatabase());
