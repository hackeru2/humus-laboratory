import { Y as useRuntimeConfig, f as useRoute$1, h as useHead } from '../server.mjs';
import { defineComponent, useSlots, h, useSSRContext, unref, watch } from 'vue';
import { G as withTrailingSlash, j as joinURL, w as withoutTrailingSlash, N as hasProtocol } from '../../nitro/node-server.mjs';
import _sfc_main$2 from './ContentRenderer-YBpt4f7p.mjs';
import _sfc_main$1 from './ContentQuery-Xm-_H6BK.mjs';
import '../../index3.mjs';
...
import './query-SikIwG9o.mjs';

const useContentHead = (_content, to = useRoute$1()) => {
...
const ContentDoc = defineComponent({
  ...
  render(ctx) {
    ...
    const contentQueryProps = {
      ...query || {},
      path: path || (query == null ? void 0 : query.path) || withTrailingSlash(useRoute$1().path),
      find: "one"
    };
