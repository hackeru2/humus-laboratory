...
import { b8 as useOgImageRuntimeConfig, b9 as useSiteConfig } from '../server.mjs';
import { defineComponent, computed, h, mergeProps, unref, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const IconComponent = runtimeConfig.hasNuxtIcon ? __nuxt_component_0 : defineComponent({
      render() {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/nuxt-og-image/dist/runtime/components/Templates/Community/NuxtSeo.vue");
