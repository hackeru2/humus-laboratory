globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { v as defineDriver, w as withoutTrailingSlash, x as withoutLeadingSlash, y as normalizeKey, l as hash, i as getQuery, h as useRuntimeConfig, z as toRouteMatcher, A as createRouter, B as defu, C as withoutBase, D as createStorage, c as createError, o as useOgImageRuntimeConfig, p as parseURL, E as withQuery, u as useNitroApp, F as prefixStorage, G as withTrailingSlash, H as useStorage, I as handleCacheHeaders, J as setHeaders, K as setHeader, d as defineEventHandler, L as H3Error } from '../nitro/node-server.mjs';
import { LRUCache } from 'lru-cache';
import { s as separateProps, n as normaliseFontInput } from '../utils.pure.mjs';
import { renderSSRHead } from '@unhead/ssr';
import { a as createHeadCore } from '../index3.mjs';
...
async function useSatoriRenderer() {
  satoriRendererInstance.instance = satoriRendererInstance.instance || await import('../index4.mjs').then((m) => m.default);
...
async function resolveRendererContext(e) {
...
function fetchIsland({ options, e }) {
...
async function devIframeTemplate(ctx) {
  const { options } = ctx;
...
export { applyInlineCss as a, applyEmojis as b, useResvg as c, decodeHtml as d, useSharp as e, fetchIsland as f, htmlDecodeQuotes as h, image$1 as i, lruCacheDriver as l, theme as t, useSatori as u };
