globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'vue-bundle-renderer/runtime';
import { e as eventHandler, s as setResponseHeader, a as send, g as getResponseStatus, b as setResponseStatus, u as useNitroApp, f as setResponseHeaders, j as joinURL, h as useRuntimeConfig, i as getQuery, c as createError, k as getRouteRules, l as hash, m as getResponseStatusText, r as readBody, n as destr } from '../nitro/node-server.mjs';
import { stringify, uneval } from 'devalue';
import { renderToString } from 'vue/server-renderer';
import { renderSSRHead } from '@unhead/ssr';
import { c as createServerHead$1, C as CapoPlugin } from '../index3.mjs';
...
const appHead = {"link":[{"rel":"icon","href":"/favicon.ico","sizes":"any"},{"rel":"icon","href":"/favicon-16x16.png","type":"image/png","sizes":"16x16"},{"rel":"icon","href":"/favicon-32x32.png","type":"image/png","sizes":"32x32"},{"rel":"icon","href":"/favicon.svg","type":"image/svg","sizes":"981x981"},{"rel":"icon","href":"/icon.svg","type":"image/svg","sizes":"981x981"},{"rel":"apple-touch-icon","href":"/apple-touch-icon.png","type":"image/png","sizes":"180x180"}],"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"}};
...
const renderer = defineRenderHandler(async (event) => {
  ...
  const inlinedStyles = isRenderingIsland ? await renderInlineStyles(ssrContext.modules ?? ssrContext._registeredComponents ?? []) : [];
